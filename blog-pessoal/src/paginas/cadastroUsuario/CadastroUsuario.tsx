...
function CadastroUsuario() {
    ...
    return (
        <Grid container direction='row' justifyContent='center' alignItems='center' className='paper'>
            ...
            <Grid item xs={6} alignItems='center'>
                <Box paddingX={10}>
                    <form onSubmit={onSubmit}>
                        ...
                        <TextField value={confirmarSenha} onChange={(e: ChangeEvent<HTMLInputElement>) => confirmarSenhaHandle(e)}id='confirmarSenha' label='Confirme sua senha' variant='outlined' name='confirme sua senha' margin='normal' type='password' fullWidth />
